    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '• Payment data: transaction identifiers and payment amounts. The Provider does not store payment card numbers, wallet credentials, or private keys.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '• Payment transaction data (identifiers and amounts; no payment credentials are stored).',
