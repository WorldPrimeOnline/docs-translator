import type { ScriptName } from '@/lib/document-language';

export type ScriptRenderProfile = {
  direction: 'ltr' | 'rtl';
  fontFamily: string;
  fallbackFonts: string[];
  /** false = CJK/Thai: allow break-all, no hyphenation */
  supportsWordBreaking: boolean;
  lineHeightMultiplier: number;
  defaultFontSizePt: number;
};

// All fonts listed are confirmed present in Railway Docker via fonts-noto,
// fonts-noto-cjk, fonts-thai-tlwg, and fonts-liberation packages.
